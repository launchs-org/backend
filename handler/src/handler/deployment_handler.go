...
func (deploymentHandler *DeploymentHandler) ApplyDeployment(echoCtx echo.Context) error {
	...
	return echoCtx.JSON(http.StatusAccepted, applyResult) // 202 Accepted + workflow_id を返す
}
