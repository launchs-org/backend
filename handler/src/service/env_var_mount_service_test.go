...
func (mock *mockDeploymentRepositoryForMount) UpdatePendingImageID(ctx context.Context, deploymentID string, imageID string) error {
	return nil // テストでは使用しないためデフォルト nil を返す
}
...
func (mock *mockDeploymentRepositoryForMount) UpdatePendingGithubBuildFields(ctx context.Context, deploymentID string, repoURL string, branch string, commitSHA string, directory string) error {
	return nil // テストでは使用しないためデフォルト nil を返す
}
...
func (mock *mockDeploymentRepositoryForMount) UpdateDeploymentStatus(ctx context.Context, deploymentID string, status models.DeploymentStatus) error {
	return nil // テストでは使用しないためデフォルト nil を返す
}

func (mock *mockDeploymentRepositoryForMount) UpdateCurrentBuildID(ctx context.Context, deploymentID string, buildID string) error {
	return nil // テストでは使用しないためデフォルト nil を返す
}

func (mock *mockDeploymentRepositoryForMount) ClearCurrentBuildID(ctx context.Context, deploymentID string) error {
	return nil // テストでは使用しないためデフォルト nil を返す
}
...
func (mock *mockDeploymentRepositoryForMount) CreateWithTx(ctx context.Context, tx *gorm.DB, deployment *models.Deployment) error {
	return nil // テストでは使用しないためデフォルト nil を返す
}
